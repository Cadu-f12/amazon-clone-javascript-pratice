...
export default function renderOrderSummary() {
            ...
            js-cart-item-container-${mathingProduct.id}">
                ...
                <div class="cart-item-details-grid">
                    ...
                    <div class="cart-item-details">
                        <div class="product-name js-product-name-${mathingProduct.id}">
                            ${mathingProduct.name}
                        </div>
                        <div class="product-price js-product-price-${mathingProduct.id}">
                        ...
                        js-product-quantity-${mathingProduct.id}">
                            ...
                            js-delete-link-${mathingProduct.id}" data-product-id="${mathingProduct.id}">
                                Delete
                            </span>
                        </div>
                    </div>
    ...
    function deliveryOptionHTML(i, cartItem) {
        ...
        deliveryOption.forEach((deliveryOption) => {
            ...
            js-delivery-option 
            js-delivery-option-${cartItem.id}-${deliveryOption.id}"
            data-product-id="${cartItem.id}"
            data-delivery-option-id="${deliveryOption.id}">
                <input type="radio"
                ${isChecked ? 'checked' : ''}
                class="delivery-option-input
                js-delivery-option-input-${cartItem.id}-${deliveryOption.id}"
